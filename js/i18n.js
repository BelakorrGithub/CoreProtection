...
var i18n = {
  es: {
    ...
    completeLevel: n => `Completar nivel ${n}`,
    shieldUpgradeTip: '¡Puedes mejorar el escudo al nivel 1 en Mejoras!',
    help: 'Ayuda',
  ...
  en: {
    ...
    completeLevel: n => `Complete level ${n}`,
    shieldUpgradeTip: 'You can upgrade your shield to level 1 in Upgrades!',
    help: 'Help',
  ...
  fr: {
    ...
    completeLevel: n => `Terminer le niveau ${n}`,
    shieldUpgradeTip: 'Vous pouvez améliorer le bouclier au niveau 1 dans Améliorations !',
    help: 'Aide',
